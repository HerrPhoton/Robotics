...
def generate_launch_description():
    ...
    # Setup project paths
    pkg_project_bringup = get_package_share_directory('diff_drive_robot')
    pkg_project_description = get_package_share_directory('diff_drive_robot_desc')
    ...
    rviz = Node(
        ...
        executable='rviz2',
        arguments=[
            '-d', os.path.join(pkg_project_bringup, 'rviz', 'diff_drive.rviz')],
